...
public class TestThermometer {
    public static void main(String[] args) {
        ...
        output += "\n\nCalling the no-argumeant constructor.... setting the temperature of the Second thermometer to 0C\nSecond thermometer:\n" + t2.toString();

        Thermometer t3 = new Thermometer();

        t2.setTemperature();

        output += "\n\nCalling the setTemperature().... setting the temperature of the Third thermometer to 25C\nThird thermometer:\n" + t2.toString();
